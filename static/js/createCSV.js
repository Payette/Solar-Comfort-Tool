...
function gatherCase1Inputs() {
    return {
        ...
        vertShadeStart: {label: "Left/Right", value: $("select#vShadeStart").val()},
...
function gatherCase2Inputs() {
    return {
        ...
        vertShadeStart: {label: "Left/Right", value: $("select#vShadeStart1").val()},
...
function createCSV() {
    ...
    if(window.SOLAR_COMFORT.MRTGrid && window.SOLAR_COMFORT.MRTGrid.length > 0) {
    ...
    if(window.SOLAR_COMFORT.MRTGrid1 && window.SOLAR_COMFORT.MRTGrid1.length > 0) {
