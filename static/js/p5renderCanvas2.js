...
p.setup = function() {
 ...
 p.draw = function() {
    ...
    document.getElementsByName("long1")[0].addEventListener('change', p.reload);

    let Lat = document.getElementById("lat1").value;
    document.getElementsByName("lat1")[0].addEventListener('change', p.reload);

    let TimeZone = document.getElementById("timeZone1").value;
    document.getElementsByName("timeZone1")[0].addEventListener('change', p.reload);


    let Day = document.getElementById("day1").value;
    document.getElementsByName("day1")[0].addEventListener('change', p.reload);

    let Month = document.getElementById("mon1").value;
    document.getElementsByName("mon1")[0].addEventListener('change', p.reload);
